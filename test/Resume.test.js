...
describe('Resume', () => {
  ...
  it('successfully uploads a person\'s document', async () => {
    ...
    await resume.methods.deleteDocument1(accounts[1]).send({ from: accounts[1] });
  ...
  it('successfully uploads a person\'s document 2', async () => {
    ...
    await resume.methods.deleteDocument2(accounts[1]).send({ from: accounts[1] });
  ...
  it('successfully uploads a person\'s document 4', async () => {
    ...
    await resume.methods.deleteDocument4(accounts[1]).send({ from: accounts[1] });
  ...
  it('successfully uploads a person\'s document 5', async () => {
    ...
    await resume.methods.deleteDocument5(accounts[1]).send({ from: accounts[1] });
